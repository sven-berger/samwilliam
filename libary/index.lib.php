  ...
  <div class="flex flex-col lg:flex-row gap-6">
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 hover:shadow-lg hover:border-red-500 hover:border-4 hover:bg-white transition duration-300">
      <h3 class="text-xl font-semibold text-red-500 mb-2">
        <i class="fa-solid fa-graduation-cap icon-xl"></i> IHK-Abschlussprüfung I
      </h3>     
    ...
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 hover:shadow-lg hover:border-red-500 hover:border-4 hover:bg-white transition duration-300">
      <div class="flex justify-between text-xl font-semibold text-red-500 mb-2">
        ...
        <span class="flex items-center">
          <i class="fa-brands fa-js icon-xl text-yellow-500 mr-2"></i> Stimulus
        </span>
        <span class="flex items-center">
          <i class="fa-brands fa-css icon-xl text-blue-500 mr-2"></i> Tailwind
        </span>
      </div>
    ...
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 hover:shadow-lg hover:border-red-500 hover:border-4 hover:bg-white transition duration-300">
      <h3 class="text-xl font-semibold text-red-500 mb-2">
        <i class="fa-brands fa-php icon-xl"></i> PHP
      </h3>
...
<section>
  ...
  <div class="flex flex-col lg:flex-row gap-6">
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 hover:shadow-lg hover:border-red-500 hover:border-4 hover:bg-white transition duration-300">
      <h3 class="text-xl font-semibold text-red-500 mb-2">
        <i class="fa-solid fa-code icon-xl"></i> Ruby
      </h3>
    ...
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 hover:shadow-lg hover:border-red-500 hover:border-4 hover:bg-white transition duration-300">
      <h3 class="text-xl font-semibold text-red-500 mb-2">
        <i class="fa-brands fa-react icon-xl"></i> React
      </h3>
    ...
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 hover:shadow-lg hover:border-red-500 hover:border-4 hover:bg-white transition duration-300">
      <h3 class="text-xl font-semibold text-red-500 mb-2">
        <i class="fa-solid fa-database icon-xl"></i> Datenbank-Architektur
      </h3>
