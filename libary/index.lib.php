...
<section class="mb-20">
  <h2 class="inline-block text-5xl mt-5 mb-10 border-b-4 text-red-500 border-orange-400 pb-2 font-bold">Aktueller Wissensstand</h2>
  <div class="flex flex-col lg:flex-row gap-6">
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 shadow-md">
    ...
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 shadow-md">
      <h3 class="text-xl font-semibold text-red-500 mb-2">Tailwind & Stimulus</h3>
    ...
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 shadow-md">
      <h3 class="text-xl font-semibold text-red-500 mb-2">PHP-Grundlagen</h3>
...
<section class="mb-20">
  ...
  <div class="flex flex-col lg:flex-row gap-6">
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 shadow-md">
      <h3 class="text-xl font-semibold text-red-500 mb-2">Ruby on Rails</h3>
    ...
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 shadow-md">
      <h3 class="text-xl font-semibold text-red-500 mb-2">React</h3>
    ...
    <div class="flex-1 bg-white border border-gray-300 rounded-lg p-6 shadow-md">
      <h3 class="text-xl font-semibold text-red-500 mb-2">Datenbank-Architektur</h3>
